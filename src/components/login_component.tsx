...
export default function LoginComponent() {
  ...
  return (
    ...
    <div className="login-container-component w-full h-auto flex flex-col-reverse md:flex-row items-center justify-center min-h-screen relative z-10 px-4 md:px-0">
  <div className="text-white flex items-center justify-center p-4 md:p-10 w-full max-w-md" style={{ touchAction: 'manipulation' }}>
    <SpotlightCard
      className="w-full backdrop-blur-xs border-2 border-white/50 bg-white/10"
      ...
      <div className="space-y-5">
        ...
        <FormControl fullWidth>
          ...
          <p className="text-center font-sans font-bold text-gray-400 mt-10 ">
            <button onClick={handleSubmit} className="hover:text-white border-white/50 cursor-pointer border-2 transition-all text-white font-bold py-3 px-8 rounded w-full md:w-auto" > Sign in </button>
          </p>
        </FormControl>
      </div>
    </SpotlightCard>
